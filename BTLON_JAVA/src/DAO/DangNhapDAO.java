...
public class DangNhapDAO {
    ...
    public static String getPassword(String user) {
        String password = "";
        try {
            String sql = "select MATKHAU from NHANVIEN where TAIKHOAN = '" + user.trim() + "'";
    ...
    public static String getUsername(String user) {
        String username = "";
        try {
            String sql = "select TAIKHOAN from NHANVIEN where TAIKHOAN = '" + user.trim() + "'";
            ConnectionDB cn = new ConnectionDB();
            cn.getCn();
            ResultSet rs = cn.executeQuery(sql);
            while (rs.next()) {
    ...
    public static String getFullName(String taikhoan) {
        String username = "";
        try {
            String sql = "select HOTEN from NHANVIEN where TAIKHOAN = '" + taikhoan + "'";
            ConnectionDB cn = new ConnectionDB();
            cn.getCn();
            ResultSet rs = cn.executeQuery(sql);
            while (rs.next()) {
